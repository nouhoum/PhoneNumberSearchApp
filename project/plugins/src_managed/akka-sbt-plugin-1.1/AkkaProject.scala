...
trait AkkaBaseProject extends BasicScalaProject {
  ...
  lazy val org_scala_tools_testing_scalacheck_2_9_0_1_9 = ModuleConfiguration("org.scala-tools.testing", "scalacheck_2.9.0", "1.9", Scala_Tools_Repo)
